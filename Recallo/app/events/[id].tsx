...
export default function EventDetailsScreen() {
  ...
  const screenTitle = Array.isArray(eventName) ? eventName[0] : eventName ?? "Event Details";
        ...
        <View style={styles.section}>
          ...
          <View style={styles.peopleContainerGrid}>
            {friends && friends.length > 0 ? (
                ...
                >
                  <View style={styles.avatarPlaceholder}>
                      <Text style={styles.avatarText}>
                        {friend.friend_name ? friend.friend_name[0].toUpperCase() : '?'}
                      </Text>
                  </View>
              ...
              <Text style={styles.emptyTextFullWidth}>No people associated with this event.</Text>
            )}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  emptyTextFullWidth: { // Used inside the grid container when empty
    width: '100%',
    color: palette.textSecondary,
    fontSize: 14,
    fontFamily: 'Nunito-Regular',
