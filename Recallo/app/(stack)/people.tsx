...
export default function PeopleScreen() {
  ...
  const renderEmptyComponent = () => (
    <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptySubText}>Add a friend when you capture a new memory!</Text>
    </View>
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.grid}>
          {friends.length === 0 ? renderEmptyComponent() : friends.map((friend) => (
            <TouchableOpacity 
              key={friend.id} 
              style={styles.card}
            ...
            >
              ...
              <View style={styles.stats}>
                <Text style={styles.statText}>
                    {friend.event_count} {friend.event_count === 1 ? 'Event' : 'Events'}
                </Text>
